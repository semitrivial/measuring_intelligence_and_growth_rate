...
\label{evaderpredictordefn}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            the result of applying $p$ to $e$'s first $n+1$ evasions.
...
\begin{definition}
    ...
    For each $n\in\mathbb N$, we write $t_{e,p}(n)$ for the
    number of steps it takes for $e$ to run in order to compute
    $x_n=e(y_0,\ldots,y_{n-1})$, where $(x_0,y_0,x_1,y_1,\ldots)$
    is the result of $p$ playing against $e$.
\end{definition}
