...
\begin{proof}
    ...
    $t_e$ is $<\hat f$, we will show $p$ $\mathcal U$-learns $e$.

    Let $(x_1,y_1,x_2,y_2,\ldots)$ be the result of $p$ playing against $e$.
    Let
    \begin{align*}
        N_1 &= \{n\in\mathbb N\,:\,f(n)>t_e(n)\},\\
        N_2 &= \{n\in N_1\,:\,p(x_1,\ldots,x_n)=e(y_1,\ldots,y_n)\},\\
        N_3 &= \{n\in\mathbb N\,:\,p(x_1,\ldots,x_n)=e(y_1,\ldots,y_n)\}.
    \end{align*}
    ...
    $x_{n+1}=y_{n+1}$, i.e., $p(x_1,\ldots,x_n)=e(y_1,\ldots,y_n)$.
    ...
    $N_3\in\mathcal U$, that is, $p$ $\mathcal U$-learns $e$, as desired.
\end{proof}
