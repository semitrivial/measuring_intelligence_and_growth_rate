...
predictors). Hibbard's measure depends on a functions-sequence
...
essentially because the functions in Liu's paper are
...
However, simple Hibbard measures are still flawed. To repair that flaw,
we propose what we call transfinite Hibbard measures,
