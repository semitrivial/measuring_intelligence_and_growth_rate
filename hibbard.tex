...
In the following broad definition, we define one intelligence measure for
every function-sequence of functions from $\mathbb N$ to $\mathbb N$.
...
\label{classichibbardmeasuredefn}
    ...
    the enumeration of the primitive recursive functions described by Liu
