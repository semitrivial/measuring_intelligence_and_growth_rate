...
\label{fairsequencedefn}
    ...
    \begin{quote}
        ...
        \begin{enumerate}
            ...
            \item (Fullness)
            $h_1,h_2,\ldots$ includes, in some sense, functions with a representative
            range of growth rates: it is up to your discretion how to interpret this
            constraint, as long as you satisfy the above three constraints.''
        \end{enumerate}
    \end{quote}
\end{definition}
