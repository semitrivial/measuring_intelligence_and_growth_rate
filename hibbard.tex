...
language\footnote{It is somewhat unclear exactly how explicitly an AGI would
obey certain commands; to use an example of Yampolskiy
\cite{yampolskiycontrol}, if an AGI were driving us in a car on a highway,
and we asked the AGI to stop the car, would the AGI immediately stop the car
...
tasks of an abstract and mathematical nature.}.
