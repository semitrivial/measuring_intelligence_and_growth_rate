...
\begin{itemize}
    ...
    \item
    In Section ..., we present an elementary way to remedy Hibbard's intelligence
    ...
    \item
    In Section ..., we review the \emph{slow-growing hierarchy} and
    \emph{Kleene's $\mathcal O$}.
    \item
