...
\begin{theorem}
    ...
    Let $X$ be an AGI, and let $p$ be $X$'s brute-force predictor.
    For any predictor $q$ and any evader $e$, if $X$ knows that $q$ is
    a predictor and if $q$ learns $e$ but-not-without-a-fight,
    then $p$ learns $e$.
\end{theorem}
