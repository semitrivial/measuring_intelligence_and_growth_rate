...
then lead to a numerical intelligence measure anyway). Given two functions $f$
...
Adapting the key insight from \citep{alexander2019intelligence}, consider each $n\in\mathbb N$
...
\begin{proof}
    ...
    Clearly $N_{fh}\subseteq N_{fg}\cap N_{gh}$, so, by (2) of
