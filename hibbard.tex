...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item $T_i$ halts and outputs $x_n$ on input $(y_1,\ldots,y_{n-1})$
            within $\leq f_m(n)$ steps.
        \item $T_i$ halts with some output $X_{i,n}$ on input $(y_1,\ldots,y_n)$
            within $\leq f_m(n)$ steps.
    \end{itemize}
    ...
    \begin{enumerate}
        \item
        For all sufficiently large $n$, on input $(x_1,\ldots,x_n)$, $p$ identifies
        $T_{k'}$ as the first $n$th-order $e$-lookalike for some $k'\leq k$ (possibly
        depending on $n$), and does not get tricked by $T_{k'}$. Or,
        \item
