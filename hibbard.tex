...
\label{evaderpredictordefn}
    ...
    \begin{enumerate}
        ...
        functions $B^*\to B$, but this would not add much to the paper and so we prefer
...
\begin{proof}
    ...
    (loosely speaking: $p$ is led to believe the evader is $T_{k'}$, but this
...
non-computable, we conjecture that the hyperreal ASPI taxonomy is even harder to
compute (in a computability theoretical sense).
