...
(the theory of AGIs), one can sometimes avoid making arbitrary decisions by
instead delegating those decisions to the AGIs under investigation.
In 2011, Hibbard suggested an intelligence measure for predictors in adversarial
sequence prediction games (and, implicitly, for AGIs acting as such
predictors). Hibbard's measure depends arbitrarily on a function-sequence
