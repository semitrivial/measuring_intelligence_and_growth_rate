...
\begin{proof}
    ...
    If the proposition were false, then we could use $F$ to solve
    ...
    if $M$ halts in $\leq n$ steps, or $0$ otherwise.
    Clearly, $M$ halts if and only if $p_M$ has
    original Hibbard measure $>m$.
\end{proof}
