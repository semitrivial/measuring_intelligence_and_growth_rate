...
\begin{definition}
For any $f,g:\mathbb N\to\mathbb N$, write $f>g$ as shorthand for the statement
...
\begin{proof}
    ...
    Thus, for each $i$, $f>f_i$, because for all $x\geq i$,
    ...
    $f_i>f$. So $f>f_i$ and $f_i>f$, a contradiction.
\end{proof}
...
\label{nonarchimedeantheorem}
    ...
    there exist AGIs $X,Y,Z$ such that the following requirements hold:
    \begin{enumerate}
...
\begin{remark}
    ...
    construct a set of AGIs with the order type of that ordinal\footnote{This
    resembles the technique from \cite{good1969godel}.}. This is a general theoretical
