...
sequence prediction games (and, implicitly, for AGIs capable of acting as such
predictors upon command). Hibbard's measure depends on a specific sequence of functions
